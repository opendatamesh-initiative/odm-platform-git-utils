...
import org.opendatamesh.platform.git.client.exceptions.ClientResourceMappingException;
import org.opendatamesh.platform.git.client.exceptions.GitUtilsException;
import org.opendatamesh.platform.git.client.http.HttpEntity;
import org.opendatamesh.platform.git.client.http.HttpHeader;
import org.opendatamesh.platform.git.client.http.HttpMethod;
import org.opendatamesh.platform.git.client.jackson.PageUtility;
...
class BaseRestUtils implements RestUtils {
     ...
     * @throws GitUtilsException if reflection fails or an error occurs during parameter construction.
     */
    private <F> void buildUriComponentFromFilters(UriComponents uriComponents, F filters) {
        try {
            ...
            throw new GitUtilsException(e.getMessage(), e);
        }
    }
