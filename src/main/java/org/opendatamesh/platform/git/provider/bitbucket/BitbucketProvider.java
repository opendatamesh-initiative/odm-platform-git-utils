package org.opendatamesh.platform.git.provider.bitbucket;
...
import org.opendatamesh.platform.git.provider.bitbucket.resources.getcurrentuser.BitbucketGetCurrentUserMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.getcurrentuser.BitbucketGetCurrentUserUserRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.getorganization.BitbucketGetOrganizationMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.getorganization.BitbucketGetOrganizationWorkspaceRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.getrepository.BitbucketGetRepositoryMapper;
...
import org.opendatamesh.platform.git.provider.bitbucket.resources.listbranches.BitbucketListBranchesBranchRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listbranches.BitbucketListBranchesMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listcommits.BitbucketListCommitsCommitListRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listcommits.BitbucketListCommitsCommitRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listcommits.BitbucketListCommitsMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listmembers.BitbucketListMembersMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listmembers.BitbucketListMembersUserListRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listmembers.BitbucketListMembersWorkspaceMembershipRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listorganizations.BitbucketListOrganizationsMapper;
...
import org.opendatamesh.platform.git.provider.bitbucket.resources.listorganizations.BitbucketListOrganizationsWorkspaceRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listprojects.BitbucketListProjectsMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listprojects.BitbucketListProjectsProjectListRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listprojects.BitbucketListProjectsProjectRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listrepositories.BitbucketListRepositoriesMapper;
...
import org.opendatamesh.platform.git.provider.bitbucket.resources.listrepositories.BitbucketListRepositoriesRepositoryRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listtags.BitbucketListTagsMapper;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listtags.BitbucketListTagsTagListRes;
import org.opendatamesh.platform.git.provider.bitbucket.resources.listtags.BitbucketListTagsTagRes;
...
import static org.opendatamesh.platform.git.provider.bitbucket.modelextensions.BitbucketRepositoryExtension.ORGANIZATION;
import static org.opendatamesh.platform.git.provider.bitbucket.modelextensions.BitbucketRepositoryExtension.PROJECT;
 ...
 */
public class BitbucketProvider implements GitProvider, GitProviderExtension {
    ...
    public BitbucketProvider(String baseUrl, RestTemplate restTemplate, GitProviderCredential credential) throws GitProviderConfigurationException {
    ...
    public User getCurrentUser() {
        try {
            ...
            if (userResponse == null) {
                throw new GitClientException(404, "Failed to get current user");
            }
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to get current user: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to get current user: " + e.getMessage());
        }
    }
    ...
    public Page<Organization> listOrganizations(Pageable page) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list organizations: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list organizations: " + e.getMessage());
        }
    }
    ...
    public Optional<Organization> getOrganization(String id) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to get organization: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to get organization: " + e.getMessage());
        } catch (Exception e) {
            // All attempts failed
        }
    ...
    public Page<User> listMembers(Organization org, Pageable page) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list organization members: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500,
                    "Bitbucket request failed to list organization members: " + e.getMessage());
        }
    }
    ...
    public Page<Repository> listRepositories(Organization org, User usr, MultiValueMap<String, String> parameters, Pageable page) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list repositories: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list repositories: " + e.getMessage());
        }
    }
    ...
    public Optional<Repository> getRepository(String id, String ownerId) {
        try {
            ...
            if (repoResponse != null) {
                Repository repo = BitbucketGetRepositoryMapper.toInternalModel(repoResponse,
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to get repository: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to get repository: " + e.getMessage());
        }
    ...
    public Repository createRepository(Repository repositoryToCreate) {
        try {
            ...
            throw new GitClientException(500, "Failed to create repository. Status: " + response.getStatusCode());
        } catch (RestClientResponseException e) {
            if (e.getStatusCode().value() == 401) {
                throw new GitProviderAuthenticationException("Bitbucket authentication failed with provider. Please check your credentials.");
            }
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to create repository: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to create repository: " + e.getMessage());
        }
    }
    ...
    public Page<Commit> listCommits(Repository repository, CommitListFilter filter, Pageable page) {
        try {
            ...
            UriTemplateAndVariablesListCommits uriData;
            if (filter instanceof CommitListRangeFilter r) {
                uriData = buildUriTemplateAndVariablesListCommitsWithFromOrToFilters(repository, new FromOrToCommitFilters(r.from().getRefValue(), r.to().getRefValue()), page);
            } else if (filter instanceof CommitListSingleBranchFilter s) {
                uriData = buildUriTemplateAndVariablesListCommitsWithBranchName(repository, s.branch().getRefValue(), page);
            } else {
                uriData = buildUriTemplateAndVariablesListCommitsWithBranchName(repository, null, page);
            }
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list commits: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list commits: " + e.getMessage());
        }
    }
    ...
    public Page<Branch> listBranches(Repository repository, Pageable page) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list branches: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list branches: " + e.getMessage());
        }
    }
    ...
    public Page<Tag> listTags(Repository repository, Pageable page) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list tags: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list tags: " + e.getMessage());
        }
    }
    ...
    public Page<ProviderCustomResource> getProviderCustomResources(String customResourceType, MultiValueMap<String, String> parameters, Pageable pageable) {
        return this.customResourceReaders.stream()
                ...
                .orElseThrow(() -> new GitProviderConfigurationException("Bitbucket Provider, unsupported retrieval for resource type: " + customResourceType));
    }
    ...
    private Page<ProviderCustomResource> listProjects(MultiValueMap<String, String> parameters, Pageable pageable) {
        try {
            ...
            throw new GitClientException(e.getStatusCode().value(),
                    "Bitbucket request failed to list projects: " + e.getResponseBodyAsString());
        } catch (RestClientException e) {
            throw new GitClientException(500, "Bitbucket request failed to list projects: " + e.getMessage());
        }
    }
    ...
    private record FromOrToCommitFilters(String from, String to) {
    }
