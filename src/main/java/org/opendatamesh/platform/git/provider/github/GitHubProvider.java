...
import org.opendatamesh.platform.git.provider.github.resources.getcurrentuser.GitHubGetCurrentUserMapper;
import org.opendatamesh.platform.git.provider.github.resources.getcurrentuser.GitHubGetCurrentUserUserRes;
import org.opendatamesh.platform.git.provider.github.resources.getorganization.GitHubGetOrganizationMapper;
import org.opendatamesh.platform.git.provider.github.resources.getorganization.GitHubGetOrganizationOrganizationRes;
import org.opendatamesh.platform.git.provider.github.resources.getrepository.GitHubGetRepositoryMapper;
...
import org.opendatamesh.platform.git.provider.github.resources.listbranches.GitHubListBranchesMapper;
...
import org.opendatamesh.platform.git.provider.github.resources.listcommits.GitHubListCommitsMapper;
import org.opendatamesh.platform.git.provider.github.resources.listmembers.GitHubListMembersMapper;
import org.opendatamesh.platform.git.provider.github.resources.listmembers.GitHubListMembersUserRes;
import org.opendatamesh.platform.git.provider.github.resources.listorganizations.GitHubListOrganizationsMapper;
import org.opendatamesh.platform.git.provider.github.resources.listorganizations.GitHubListOrganizationsOrganizationRes;
import org.opendatamesh.platform.git.provider.github.resources.listrepositories.GitHubListRepositoriesMapper;
import org.opendatamesh.platform.git.provider.github.resources.listrepositories.GitHubListRepositoriesRepositoryRes;
import org.opendatamesh.platform.git.provider.github.resources.listtags.GitHubListTagsMapper;
...
public class GitHubProvider implements GitProvider {
    ...
    public GitHubProvider(String baseUrl, RestTemplate restTemplate, GitProviderCredential credential) throws GitProviderConfigurationException {
    ...
    public Page<Commit> listCommits(Repository repository, CommitListFilter filter, Pageable page) {
        try {
            ...
            if (filter instanceof CommitListRangeFilter r) {
                ...
                Map<String, Object> uriVariables = constructUriVariablesListCommitsCompare(ownerName, repoName, r.from().getRefValue(), r.to().getRefValue(), page);
            ...
            if (filter instanceof CommitListSingleBranchFilter s) {
                ...
                Map<String, Object> uriVariables = constructUriVariablesListCommitsWithBranch(ownerName, repoName, s.branch().getRefValue(), page);
    ...
    private Map<String, Object> constructUriVariablesListCommitsCompare(String ownerName, String repoName, String from, String to, Pageable page) {
        Map<String, Object> uriVariables = new HashMap<>();
        uriVariables.put("owner", ownerName);
        uriVariables.put("repo", repoName);
